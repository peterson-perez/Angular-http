...
export const Pages = [HomePageComponent, EditproductComponent, ListAllproductsComponent, ProductsComponent, AddProductsComponent, ProductsFormComponent, GetproductbynameComponent, DeleteproductComponent, 
  // EditStockComponent
];
